...
export const GESTURES: Readonly<Record<string, GestureDef>> = {
  ...
  buy_dinner: {
    ...
    cost: 40,
    did: '*tells Sora the two of them are eating, and that the bill is his, before she can object*',
    reaction: 'She raises an eyebrow that could mean anything and lets Sora choose for her. "I will let you, this once. I am keeping count."',
    interestDelta: 7,
    comfortDelta: 3,
  },
  buy_coffee: {
  ...
  buy_noodles: {
    id: 'buy_noodles',
    label: 'Get her a bowl',
    cost: 16,
    did: '*orders two bowls from Tam without asking what she wants, and gets it right*',
    reaction: 'She looks at the bowl, then at you, and picks up the chopsticks. "You guessed the spicy one. Either you were listening or you got lucky. Do not tell me which."',
    interestDelta: 5,
    comfortDelta: 4,
  },
  arcade_round: {
